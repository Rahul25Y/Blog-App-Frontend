    ...
    <div className="container py-4 fade-in-el">
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div
            className="card border-color shadow-sm mb-4"
            ...
            <div className="card-body p-4">
              ...
              <div className="row g-4">
                <div className="col-md-6">
                  <div
                    className="p-3 rounded border border-color"
                    style={{ backgroundColor: "var(--bg-color)" }}
                  >
                    <p
                      className="text-muted-custom mb-1 text-uppercase fw-semibold"
                ...
                <div className="col-md-6">
                  ...
                  >
                    ...
                    <p className="mb-0 fw-medium text-color">
                      {user.blogs?.length || 0}
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                <div className="modal-body text-color">
                  <p className="mb-0">
                    ...
                    cannot be undone and you will lose access to all your blogs.
                  </p>
                </div>
